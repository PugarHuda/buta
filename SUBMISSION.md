...
| **TEE machine in PRODUCTION** | `0xF9964B52CDe4aAb52E5824E411B8B78531911BE6`, `getTeeMachineStatus` = 2. `getRandomTeeIds(65642, 1)` returns it instead of reverting `TooMany()`. The first machine, `0x473e5B49…77Ee`, is PAUSED — a restarted container mints a new key, and leaving the old one active means half the instructions route to nobody (`scripts/retire-machine.mjs`) |
