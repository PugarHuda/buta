...
- Network: Coston2 (chain 114). TEE machine `0x7FB72954…10BA` is registered and PRODUCTION for extension 66009 — `getRandomTeeIds` resolves instead of reverting `TooMany()`. Enclave on the simulated-TEE path.
