...
- Network: Coston2 (chain 114). TEE machine `0xF9964B52…1BE6` is registered and PRODUCTION for extension 65642 — `getRandomTeeIds` resolves instead of reverting `TooMany()`. Enclave on the simulated-TEE path.
